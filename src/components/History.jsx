...
const History = (props) => {
  return (
    <div
      className={`absolute right-0 top-[8%] h-[85vh] w-[30vw]
    max-xl:dropHistory duration-500 
    ${
      props.showHistory
        ? "max-xl:translate-y-[0vh] "
        : "max-xl:-translate-y-[100vh]"
    }`}
    >
      <TiDelete
        size={40}
      ...
      <textarea
        ...
        name=""
        id="history"
        className="rounded-2xl max-xl:rounded-none w-full h-full text-black dark:text-white outline-none
